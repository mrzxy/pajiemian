...
def main():
    ...
    scaled_region = (
        ...
        int(946 * scale * scale_factor),  # width
        int(651 * scale * scale_factor)  # height
    )
    file = "/Users/zxy/Project/xianyu/capture/screenshots/screenshot_20250316_061851.png"
    corp_image(file, scaled_region)
    return
    scaled_region = None
